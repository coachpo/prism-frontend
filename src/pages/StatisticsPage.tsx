    ...
    <div className="space-y-6">
      ...
      >
        <TabsList className="w-fit">
          <TabsTrigger value="operations">{messages.statistics.operationsTab}</TabsTrigger>
          <TabsTrigger value="throughput">{messages.statistics.throughputTab}</TabsTrigger>
          <TabsTrigger value="spending">{messages.statistics.spendingTab}</TabsTrigger>
        </TabsList>
