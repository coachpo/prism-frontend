...
- Parent-cover local route clusters that do not need their own AGENTS file, including `__tests__/` and the dense local helper folders already documented by the page leaves.
